...
(deftest waffle-game-display-string-test
  ...
  (is (= (game-display-string (create-game :waffle)) expected-new-waffle-game-display)))

(deftest deluxe-waffle-game-display-string-test
  (testing "New Deluxe Waffle game display string should be properly generated")
  (is (= (game-display-string (create-game :deluxe-waffle)) expected-new-deluxe-waffle-game-display)))
